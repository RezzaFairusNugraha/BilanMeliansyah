...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const resultsButtonContainer = document.getElementById(
  ...
  const bioMessages = ["Hello I am the owner of FireShot"];
  let bioText = "";
  let bioIndex = 0;
  ...
  transparencySlider.addEventListener("input", () => {
    ...
    if (opacity == 0) {
      ...
      skillsBlock.style.border = "1px solid transparent";
      ...
      skillsBlock.style.border = `1px solid rgba(255, 255, 255, ${
        opacity * 0.2
      })`;
  ...
  function switchTheme(
    ...
    gsap.to(backgroundVideo, {
      ...
      onComplete: () => {
        ...
        currentAudio
          .play()
          .catch((err) => console.error("Failed to play theme music:", err));
